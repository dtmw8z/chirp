...
export function PostHeader({
  ...
  return (
    <div className="flex p-3 space-x-5 z-10 bg-white">
      <Image
      ...
      <div className="text-[14px] flex flex-col space-y-1.5">
        <div className="flex space-x-1.5  text-[#707E89]">
          ...
          {timestamp && (
            <>
              <span>·</span>
              <span>
                {formatDistance(subDays(timestamp.toDate(), 0), new Date(), {
                  addSuffix: true,
                })}
              </span>
            </>
        ...
        {replyTo && (
          <span className="text-[#707e89]">
            Replying to{" "}
            <span className="font-bold text-[#f4af01]">@{replyTo}</span>
          </span>
        )}
      </div>
    </div>
